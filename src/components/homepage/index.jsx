...
import { Row, Col, TextInput, Card } from "react-materialize";
...
export default class index extends Component {
  ...
  changeValue = (e) => {
    ...
    if (/^\d\.?\d*$/.test(e.target.value)) {
      ...
      const destValue =
        Number.parseFloat(e.target.value) * this.state["multiplier" + src];
    ...
    return (
      <div>
        <div
          ...
          className="container"
        >
          <h2 className="center-align">Convert Currency</h2>
          <Card>
            <Row>
              <Col s={6}>
                <TextInput
